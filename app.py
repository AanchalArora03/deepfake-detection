...
def predict():
    if 'video' not in request.files:
        return render_template('index.html', prediction="No video file provided")
    ...
    prediction_msg = f"The video is {result} with {confidence:.2f}% confidence"
    return render_template('index.html', prediction=prediction_msg)
